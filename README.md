...
_Last update: 2026-07-13 13:24 KST (2026-07-13 04:24 UTC)_

| Check | Value |
|---|---|
| Run | `EXP034_varnet_c4_ch12_s8_lr3e4_scorealigned_e33` (running) |
| Change | `objective-only comparison versus EXP033R control; opt-in score-aligned loss; same EXP031 source/LR/seed/budget` |
| Progress | epoch `30/33`, iteration `1290/4651`, `91.7%` |
| ETA | `2.96 hours`; finish `2026-07-13 16:22 KST (2026-07-13 07:22 UTC)` |
