...
| `LOCAL_EXP057_RETRY3` / `LOCAL_EXP058_RETRY3` | Fresh V5 matched retry of the same Adam/AdamW protocol, with hardened failure publication | pending | **LOCAL-only V5 campaign launched 2026-07-14 01:39 KST.** Adam control is training on the RTX 3090; verified at epoch 0, iteration 340/4651 with 11.3 GiB allocated, 83–99% GPU utilization, and 320–327 W draw. The AdamW arm remains queued. No metric, candidate decision, official follow-up, or further launch is authorized. |
