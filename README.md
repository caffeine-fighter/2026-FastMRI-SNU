...
|---|---|---:|---|
| `LOCAL_EXP055_RETRY2` / `LOCAL_EXP056_RETRY2` | Fresh matched c8/ch12/s8/e5 seed 430 pair: Adam (`wd=0`) control, then AdamW (`wd=1e-6`) candidate | n/a | **V4 failed closed 2026-07-14 01:27 KST.** The Adam control stalled at epoch 0, iteration 1340/4651; the watchdog raised `active_phase_log_stale_over_20m`. The operator terminated the unresponsive runner/child, and immutable emergency failure evidence was recorded. No metric, candidate decision, official follow-up, or further launch is authorized. |
| `LOCAL_EXP057_RETRY3` / `LOCAL_EXP058_RETRY3` | Fresh V5 matched retry of the same Adam/AdamW protocol, with hardened failure publication | n/a | **V5 failed closed 2026-07-14 09:41 KST.** The managed runner received SIGTERM while Adam control was at epoch 2, iteration 680/4651 (after completed epochs 0–1); durable failure evidence records child-cleanup failure. The queued AdamW arm was never launched. Partial checkpoints/reconstructions remain private and are not valid results. No metric, candidate decision, official follow-up, or further launch is authorized. |
