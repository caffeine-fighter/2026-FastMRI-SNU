...
_Last update: 2026-07-12 19:31 KST (2026-07-12 10:31 UTC)_

| Check | Value |
|---|---|
| Run | `EXP032_varnet_c6_ch12_s8_e30` (running) |
| Change | `cascades 4 to 6; all else fixed` |
| Progress | epoch `24/30`, iteration `720/4651`, `80.5%` |
| ETA | `7.80 hours`; finish `2026-07-13 03:19 KST (2026-07-12 18:19 UTC)` |
