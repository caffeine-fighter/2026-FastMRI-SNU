...
_Last update: 2026-07-12 05:00 KST (2026-07-11 20:00 UTC)_

| Check | Value |
|---|---|
| Run | `EXP032_varnet_c6_ch12_s8_e30` (running) |
| Change | `cascades 4 to 6; all else fixed` |
| Progress | epoch `13/30`, iteration `970/4651`, `44.0%` |
| ETA | `22.52 hours`; finish `2026-07-13 03:32 KST (2026-07-12 18:32 UTC)` |
