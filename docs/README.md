...
Use the root [`README.md`](../README.md) for live VESSL progress. Use this page to find the stable document for a task.
...
| Metric definitions | [`metric_notes.md`](metric_notes.md) |
...
Live status belongs only in the root README. Detailed metrics belong in the experiment log or reports. This avoids copying the same values across several pages.
