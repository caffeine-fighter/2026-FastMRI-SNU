...
- Let `EXP035_varnet_c8_ch12_s8_e30` determine the vanilla architecture baseline first.
- A future scheduler probe, if selected after EXP035, must be an independently preregistered Adam scheduler-only comparison rather than an automatic continuation of this rejected AdamW branch.
